...
import com.shakib_mansoori.newsapp.databinding.FragmentPoliticsBinding

class PoliticsFragment : Fragment(), Listener {
    ...
    override fun onCreateView(
        ...
        viewModel.getPoliticsNews().observe(viewLifecycleOwner) {
            if (it != null) {
                articlesList = it
