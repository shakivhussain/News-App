...
import com.shakib_mansoori.newsapp.databinding.FragmentFoodBinding

class FoodFragment : Fragment(), Listener {
    ...
    override fun onCreateView(
        ...
        viewModel.getFoodNews().observe(viewLifecycleOwner) {
            if (it != null) {
                articlesList = it
