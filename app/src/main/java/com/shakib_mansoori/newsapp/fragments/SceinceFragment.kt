...
import com.shakib_mansoori.newsapp.databinding.FragmentSceinceBinding


class SceinceFragment : Fragment(), Listener {


    private lateinit var binding: FragmentSceinceBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSceinceBinding.inflate(inflater)
